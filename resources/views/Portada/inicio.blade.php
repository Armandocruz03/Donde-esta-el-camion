...
<head>
    ...
    <style>
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 15px 25px -5px rgb(16 185 129 / 0.4);
...
<body class="min-h-screen text-slate-800">
    ...
    <div class="max-w-7xl mx-auto px-6 py-12">
        ...
        <div class="bg-white rounded-3xl p-16 text-center shadow-xl border border-dashed border-slate-200">
            ...
            <!-- Botones juntos con hover mejorado -->
            <div class="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
                <a href="{{ route('registro.ciudadano') }}" 
                   class="btn-primary flex-1 px-8 py-5 bg-emerald-700 text-white font-semibold rounded-2xl transition flex items-center justify-center gap-3 shadow-lg">
                    <i class="fa-solid fa-user-plus"></i>
                    Registrarme
                </a>
                
                <a href="{{ route('login') }}" 
                   class="btn-secondary flex-1 px-8 py-5 border-2 border-slate-300 font-semibold rounded-2xl transition flex items-center justify-center gap-3">
        ...
        <div class="flex justify-center gap-4 mt-10">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" 
                        class="px-10 py-4 bg-red-50 hover:bg-red-100 text-red-700 font-semibold rounded-2xl transition flex items-center gap-3 hover:scale-105">
